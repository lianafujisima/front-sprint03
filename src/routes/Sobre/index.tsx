  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-6">
      ...
      <section className="max-w-5xl mx-auto mb-12">
        <img src={Imrea}alt="Banner do Sistema" className="w-full object-contain rounded-2xl shadow-md"/>
      </section>

      <section className="max-w-4xl mx-auto mb-12 bg-white p-8 rounded-2xl shadow-md">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">Sobre o Projeto</h1>
      ...
      <section className="max-w-4xl mx-auto mb-12 bg-white p-8 rounded-2xl shadow-md text-center">
        ...
        <a href="https://wa.me/5511996534795" target="_blank" className="inline-block bg-green-500 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:bg-green-600 transition">Fale Conosco no WhatsApp</a>
      </section>
