            ...
            <section className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
                ...
                <div  className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-center hover:shadow-xl transition">
                    ...
                    <div className="text-center space-y-1">
                        ...
                        <p className="text-gray-700">Github: <a href="https://github.com/lianafujisima" target="_blank">Liana Lyumi Morisita Fujisima</a></p>
                    </div>
                </div>
                <div  className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-center hover:shadow-xl transition">
                    ...
                    <div className="text-center space-y-1">
                        ...
                        <p className="text-gray-700">Github: <a href="https://github.com/Victorcho05">Victor Willian Hwan Cho</a></p>
                    </div>
                </div>
            </section>
        </main>
